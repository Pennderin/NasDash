...
ipcMain.on('toggle-desktop-icons', () => {
  ...
  const ps1 = path.join(isPacked ? app.getPath('userData') : __dirname, 'toggle-desktop.ps1');
  ef('powershell', ['-NoProfile', '-ExecutionPolicy', 'Bypass', '-File', ps1], { windowsHide: true, timeout: 5000 }, () => {});
});
